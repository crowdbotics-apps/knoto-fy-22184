"""knoto_fy_22184 URL Configuration
...
admin.site.site_header = "KNOTO-FY"
admin.site.site_title = "KNOTO-FY Admin Portal"
admin.site.index_title = "KNOTO-FY Admin"

# swagger
api_info = openapi.Info(
    title="KNOTO-FY API",
    default_version="v1",
    description="API documentation for KNOTO-FY App",
)
