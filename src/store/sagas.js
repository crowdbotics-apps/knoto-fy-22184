...
function* api_v1_contact_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_contact_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contact_listFailed(err, action))
  }
}
...
function* api_v1_contact_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_contact_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contact_createFailed(err, action))
  }
}
...
function* api_v1_contact_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_contact_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contact_readFailed(err, action))
  }
}
...
function* api_v1_contact_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_contact_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contact_updateFailed(err, action))
  }
}
...
function* api_v1_contact_partial_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_contact_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contact_partial_updateFailed(err, action))
  }
}
...
function* api_v1_contact_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_contact_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contact_deleteFailed(err, action))
  }
}
...
function* api_v1_forwardedmessage_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_forwardedmessage_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_forwardedmessage_listFailed(err, action))
  }
}
...
function* api_v1_forwardedmessage_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_forwardedmessage_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_forwardedmessage_createFailed(err, action))
  }
}
...
function* api_v1_forwardedmessage_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_forwardedmessage_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_forwardedmessage_readFailed(err, action))
  }
}
...
function* api_v1_forwardedmessage_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_forwardedmessage_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_forwardedmessage_updateFailed(err, action))
  }
}
...
function* api_v1_forwardedmessage_partial_updateWorker(action) {
  try {
    ...
    yield put(
      actions.api_v1_forwardedmessage_partial_updateSucceeded(result, action)
    )
  } catch (err) {
    yield put(actions.api_v1_forwardedmessage_partial_updateFailed(err, action))
  }
}
...
function* api_v1_forwardedmessage_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_forwardedmessage_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_forwardedmessage_deleteFailed(err, action))
  }
}
...
function* api_v1_messageaction_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_messageaction_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_messageaction_listFailed(err, action))
  }
}
...
function* api_v1_messageaction_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_messageaction_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_messageaction_createFailed(err, action))
  }
}
...
function* api_v1_messageaction_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_messageaction_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_messageaction_readFailed(err, action))
  }
}
...
function* api_v1_messageaction_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_messageaction_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_messageaction_updateFailed(err, action))
  }
}
...
function* api_v1_messageaction_partial_updateWorker(action) {
  try {
    ...
    yield put(
      actions.api_v1_messageaction_partial_updateSucceeded(result, action)
    )
  } catch (err) {
    yield put(actions.api_v1_messageaction_partial_updateFailed(err, action))
  }
}
...
function* api_v1_messageaction_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_messageaction_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_messageaction_deleteFailed(err, action))
  }
}
...
function* api_v1_thread_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_thread_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_thread_listFailed(err, action))
  }
}
...
function* api_v1_thread_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_thread_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_thread_createFailed(err, action))
  }
}
...
function* api_v1_thread_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_thread_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_thread_readFailed(err, action))
  }
}
...
function* api_v1_thread_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_thread_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_thread_updateFailed(err, action))
  }
}
...
function* api_v1_thread_partial_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_thread_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_thread_partial_updateFailed(err, action))
  }
}
...
function* api_v1_thread_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_thread_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_thread_deleteFailed(err, action))
  }
}
...
function* api_v1_threadaction_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadaction_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadaction_listFailed(err, action))
  }
}
...
function* api_v1_threadaction_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadaction_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadaction_createFailed(err, action))
  }
}
...
function* api_v1_threadaction_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadaction_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadaction_readFailed(err, action))
  }
}
...
function* api_v1_threadaction_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadaction_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadaction_updateFailed(err, action))
  }
}
...
function* api_v1_threadaction_partial_updateWorker(action) {
  try {
    ...
    yield put(
      actions.api_v1_threadaction_partial_updateSucceeded(result, action)
    )
  } catch (err) {
    yield put(actions.api_v1_threadaction_partial_updateFailed(err, action))
  }
}
...
function* api_v1_threadaction_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadaction_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadaction_deleteFailed(err, action))
  }
}
...
function* api_v1_threadmember_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadmember_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadmember_listFailed(err, action))
  }
}
...
function* api_v1_threadmember_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadmember_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadmember_createFailed(err, action))
  }
}
...
function* api_v1_threadmember_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadmember_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadmember_readFailed(err, action))
  }
}
...
function* api_v1_threadmember_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadmember_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadmember_updateFailed(err, action))
  }
}
...
function* api_v1_threadmember_partial_updateWorker(action) {
  try {
    ...
    yield put(
      actions.api_v1_threadmember_partial_updateSucceeded(result, action)
    )
  } catch (err) {
    yield put(actions.api_v1_threadmember_partial_updateFailed(err, action))
  }
}
...
function* api_v1_threadmember_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_threadmember_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_threadmember_deleteFailed(err, action))
  }
}
...
function* api_v1_user_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_user_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_user_listFailed(err, action))
  }
}
...
function* api_v1_user_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_user_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_user_createFailed(err, action))
  }
}
...
function* api_v1_user_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_user_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_user_readFailed(err, action))
  }
}
...
function* api_v1_user_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_user_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_user_updateFailed(err, action))
  }
}
...
function* api_v1_user_partial_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_user_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_user_partial_updateFailed(err, action))
  }
}
...
function* api_v1_user_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_user_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_user_deleteFailed(err, action))
  }
}
...
function* api_v1_verificationcode_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_verificationcode_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_verificationcode_listFailed(err, action))
  }
}
...
function* api_v1_verificationcode_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_verificationcode_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_verificationcode_createFailed(err, action))
  }
}
...
function* api_v1_verificationcode_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_verificationcode_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_verificationcode_readFailed(err, action))
  }
}
...
function* api_v1_verificationcode_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_verificationcode_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_verificationcode_updateFailed(err, action))
  }
}
...
function* api_v1_verificationcode_partial_updateWorker(action) {
  try {
    ...
    yield put(
      actions.api_v1_verificationcode_partial_updateSucceeded(result, action)
    )
  } catch (err) {
    yield put(actions.api_v1_verificationcode_partial_updateFailed(err, action))
  }
}
...
function* api_v1_verificationcode_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_verificationcode_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_verificationcode_deleteFailed(err, action))
  }
}
...
export default function* rootSaga() {
  const sagas = [
    useraccountconnector_post_registration_createWatcher,
